...
var real_answer = Number(real1) * Number(real2) - Number(imaginary1) * Number(imaginary2);
var imaginary_answer = Number(real1) * Number(imaginary2) + Number(imaginary1) * Number(real2);
